    ...
    <Layout title="About Goal">
      ...
      <div class="bg-gray-100 pb-6 sm:pb-8 lg:pb-12">
        <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
          ...
          {/* --- Section 2 start --- */}
          <div class="grid md:grid-cols-2 gap-8 lg:gap-12 pt-10 sm:pt-14 lg:pt-20">
            <div class="grid-cols-2 inline-grid gap-2 h-64 md:h-auto bg-gray-100 overflow-hidden px-6">
              <div>
                <img
            ...
            <div>
              <p class="text-gray-500 sm:text-lg mb-6 md:mb-8">
                <div class="mb-1 animate-pulse text-xl font-semibold">目標について</div>
                <div class="mb-1">
