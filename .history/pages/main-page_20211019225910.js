          ...
          <section class="min-h-96 flex justify-center items-center flex-1 flex-shrink-0 bg-gray-100 overflow-hidden shadow-lg  relative py-16 md:py-20 xl:py-48">
            ...
            <div class="sm:max-w-xl flex flex-col items-center relative p-4">
              <p class="text-indigo-100 text-lg sm:text-xl text-center mb-4 md:mb-8">
                For good training life
              </p>
              <h1 class="animate-pulse text-white text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 md:mb-12">
                Revolutionary way<br/>to record training days
              </h1>
      ...
      <div class="bg-gray-100 py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div class="flex justify-between items-center gap-8 mb-4 sm:mb-8 md:mb-12">
            ...
            <a
              href="record-page"
              class="inline-block bg-white hover:bg-gray-100 active:bg-gray-200 motion-safe:hover:scale-110 ring-indigo-300 border text-gray-500 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 md:px-8 py-2 md:py-3 "
            >
              More
            </a>
          </div>
