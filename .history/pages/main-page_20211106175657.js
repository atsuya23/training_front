    ...
    <Layout title="Main-page">
      <div class="bg-gray-100 sm:pb-8 lg:pb-12  flex-grow">
        <div class="md:px-8 mx-auto">
          <section class="w-full min-h-96 flex justify-center items-center flex-1 flex-shrink-0 bg-gray-100 overflow-hidden shadow-2xl  relative py-16 md:py-20 xl:py-48">
            {/* image - start */}
