...
import { getContentDateByTrainingId, getContentIDsByTrainingId } from "../../styles/components/atoms_atomic/func/contentFunc";

export default function Training({ training, contentIds }) {
...
export async function getStaticProps({ params }) {
  ...
  const contentIds = await getContentIDsByTrainingId(training.id)
  return {
    props: {
      training,
      contentIds,
