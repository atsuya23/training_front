      ...
      <div class="bg-gray-100 pb-6 sm:pb-8 lg:pb-12">
        <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
          ...
          <div class="grid md:grid-cols-2 gap-8 lg:gap-12 pt-6 sm:pt-8 lg:pt-12 ">
            <div class="gap-2 h-64 md:h-auto bg-gray-100 overflow-hidden shadow-lg">
              <div>
                <img
                  src="https://training-rest.herokuapp.com/media/images/rise_explain.jpg"
                  loading="lazy"
                  alt="Photo by Martin Sanchez"
                  class="w-30 h-96 rounded-3xl object-cover object-center shadow-xl"
                />
              </div>
              <div>
                <img
                  ...
                  loading="lazy"
                  alt="Photo by Martin Sanchez"
                  class="w-full h-96 rounded-3xl object-cover object-center shadow-xl"
                />
              </div>
            </div>
            <div>
