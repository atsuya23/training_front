...
export default function ContentSortedType({ contents, type }) {
  ...
  let starNumber = 0;
  if (goalAmount != 0) {
    progress += Math.floor((total / goalAmount) * 100);
      ...
      <div class="bg-gray-100 py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <div>
                <div class="border rounded-3xl bg-blue-300 bg-opacity-30 p-4 shadow-xl">
                  <h3 class="text-white text-base lg:text-lg font-semibold mb-3 italic text-center">
                    Overall
                  </h3>
                  ...
                  <div class="flex items-center gap-2 mb-0.5">
                    ...
                    <span class="text-sm font-semibold">{starNumber}/10</span>
                  </div>
