...
export default function ContentSortedType({ contents, type }) {
  ...
  // const apiUrl = `${RESTAPI_URL}api/content/?training_type=${type}`;

  // const { data: newContents, mutate } = useSWR(apiUrl, fetcher, {
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <img
                ...
                class="w-full h-auto object-cover object-center rounded-full shadow-lg align-bottom mt-48"
              />
            </div>
          </div>
        </div>
