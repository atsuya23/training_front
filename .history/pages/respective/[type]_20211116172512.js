...
export default function ContentSortedType({ contents, contentsWithCreated_at }) {
...
export async function getStaticProps({ params }) {
  ...
  let contentWithCreated_at = {}
  contents.map((content) => {
    content = {
      ...content,
      content_created_at: getTrainingDate(content.id_training),
    };
    contentsWithCreated_at = {...contentsWithCreated_at, content}
  });

  return {
    props: {
      contents, contentsWithCreated_at
    },
    revalidate: 3,
  };
}
