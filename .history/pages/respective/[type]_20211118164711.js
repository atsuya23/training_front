...
export default function ContentSortedType({ contents, type }) {
  ...
  if (goalAmount != 0) {
    const doneAmount = Math.floor((total / goalAmount) * 100);
    const starNumber = Math.floor((total / goalAmount) * 5);
  }
            ...
            <div>
              <div>
                <div class="border rounded-lg p-4">
                  <h3 class="text-gray-800 text-base lg:text-lg font-semibold mb-3 animate-pulse italic">
                    Overall
                  </h3>
