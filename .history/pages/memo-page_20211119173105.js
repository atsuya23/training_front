...
export default function MemoyPage() {
  return (
    ...
    >
      <div class="flex flex-col max-w-screen-lg border-t mx-auto">
        {/* question - start */}
        <div class="border-b">
          <div class="flex justify-between text-center text-black hover:text-indigo-500 active:text-indigo-600 cursor-pointer gap-2 py-4">
