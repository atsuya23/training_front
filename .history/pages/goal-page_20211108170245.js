          ...
          <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="md:pt-8">
              ...
              <p class="text-gray-500 sm:text-lg mb-6 md:mb-8">
                ...
                <div class="mb-1">考えるに、精神論信者ではないがモノゴト本気で取り組んで成せないことなど少数であり、実際は目標に向けた取り組みへの姿勢と計画こそが本質的な達成要因であり、その維持こそが最大の課題なのである。そういった価値観を持つ者として、自身の目標達成とは自己実現の基盤であり、その不達成は自身の価値観への否定とも成り得る。
                </div>
                <div>
                  以上からとりわけ私自身にとって本目標達成は極めて重要な意味をもち、達成以外はあってはならないと考える。
                </div>
              </p>
            </div>
          </div>
