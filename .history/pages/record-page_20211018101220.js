        ...
        <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
          ...
          <div class="mb-10 md:mb-16">
            ...
            <p class="max-w-screen-md text-gray-400 md:text-l text-center mx-auto">
              本ページは、トレーニングの記録を閲覧するページとなります。<br />
              これまでの記録や継続性を可視化することによって、最終的な目標達成への筋道を確認します。<br />
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8 sm:gap-12 xl:gap-16">
            ...
            <div class="flex flex-col md:flex-row items-center gap-4 lg:gap-6">
              <a
                href="#"
                class="group w-full md:w-24 lg:w-40 h-56 md:h-24 lg:h-40 block self-start flex-shrink-0 bg-gray-100 overflow-hidden rounded-2xl shadow-lg relative"
              >
                <img
