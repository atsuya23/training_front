    ...
    <Layout title="Respective-home">
      <div class="bg-gray-100 py-6 sm:py-8 lg:py-12">
        ...
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto mt-16">
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 md:gap-x-6 gap-y-3">
            {/* each training - start */}
            <EachTraining
            ...
            <EachTraining
              ...
              menuName="サイドレイズ"
            />
            <EachTraining picPath="https://training-rest.herokuapp.com/media/images/push-up.png" menuName="腕立て伏せ" />
            {/* each training - end */}
          </div>
        </div>
      </div>
