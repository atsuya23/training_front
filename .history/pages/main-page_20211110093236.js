      ...
      <div class="bg-gray-100 sm:pb-8 lg:pb-12  flex-grow">
        <div class="">
          <section class="flex justify-center items-center flex-1 flex-shrink-0 bg-gray-100 overflow-hidden shadow-2xl  relative py-16 md:py-20 xl:py-48 min-h-screen">
            ...
            <img
              src="https://training-rest.herokuapp.com/media/images/push-up.png"
              loading="lazy"
      ...
      <div class="bg-gray-100 py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 xl:gap-8">
            ...
            <a
              href="#"
              class="group h-56 md:h-80 md:col-span-2 flex items-end bg-gray-100 overflow-hidden rounded-lg shadow-lg relative"
            >
              <img
            ...
            <a
              href="#"
              class="group h-56 md:h-80 flex items-end bg-gray-100 overflow-hidden rounded-lg shadow-lg relative"
            >
              <img
