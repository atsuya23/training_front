        ...
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          >
            <div class="flex">
              <div class="mr-8">
                ...
                <input
                  ...
                  class="bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded-2xl outline-none transition duration-400 px-5 py-3"
                />
              </div>
            ...
            <div class="sm:col-span-2">
              ...
              <textarea
                name="message"
                class="w-full  bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded-2xl outline-none transition duration-400 px-3 py-2"
              ></textarea>
            </div>
