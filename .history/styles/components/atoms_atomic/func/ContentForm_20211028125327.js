          ...
          <div class="flex">
            <div class="sm:col-span-2 mr-8">
              ...
              <input
                ...
                class="bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded-2xl outline-none transition duration-400 py-3 shadow-lg"
              />
            </div>
            <div class="sm:col-span-2 mr-8"> 
              <label
            ...
            <div class="sm:col-span-2">
              ...
              <input
                ...
                class="bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded-full outline-none transition duration-400 py-3 shadow-lg w-25"
              />
            </div>
          </div>
