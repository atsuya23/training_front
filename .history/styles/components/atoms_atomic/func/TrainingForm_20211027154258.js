        ...
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          >
            ...
            <div class="sm:col-span-2 flex justify-between items-center">
              <a class="inline-block bg-indigo-500 hover:bg-indigo-700 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-3xl outline-none transition duration-100 px-6 py-3">
                Register
              </a>
