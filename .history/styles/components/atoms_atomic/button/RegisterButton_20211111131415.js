  ...
  return (
    <Link href="../register-page">
      ...
      <a
        ...
        class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 rounded-full hover:pl-10 hover:pr-6 bg-gray-100 opacity-100 group ease-in-out"
      >
