...
{/* 
      ...
      >
        <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-purple-500 group-hover:translate-x-0">
          <svg
            class="w-6 h-6"
            fill="none"
            stroke="currentColor"
