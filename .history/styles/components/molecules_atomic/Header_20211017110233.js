      ...
      <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <header class=" flex justify-between items-center md:py-3">
          ...
          <div class="hidden lg:flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5 -ml-8">
            ...
            <a
              href="#"
              class="inline-block bg-green-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-xl outline-none transition duration-100 px-8 py-3"
            >
              Sign up
            </a>
          </div>
