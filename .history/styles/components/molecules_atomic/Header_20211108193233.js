      ...
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <Link href="../about-page">
            <a
              class="hover:text-gray-100 hover:underline inline-flex items-center text-gray-600 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 transition"
              aria-label="logo"
            >
              <PencilIcon class="w-8 h-9 text-gray-100 animate-pulse" />
              Record Training
            </a>
          </Link>
          {/* logo - end */}
