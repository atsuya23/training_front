      ...
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <nav class="hidden lg:flex gap-7 mt-1 ml-8 underline">
            <a
              href="main-page"
              class="text-gray-500 hover:text-indigo-500 hover:bg-gray-200 rounded-lg active:text-indigo-700 text-lg font-semibold transition duration-100 px-1"
            >
              Main
            </a>
            <a
              href="record-page"
              class="inline-flex items-center text-gray-500 hover:text-indigo-500 hover:bg-gray-200 rounded-lg active:text-indigo-700 text-lg font-semibold transition duration-100"
            >
              Record
            </a>
            <a
