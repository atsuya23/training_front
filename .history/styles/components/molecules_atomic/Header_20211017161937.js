...
export default function Header() {
  return (
    <div class="bg-gray-300 sticky">
      <div class="max-w-screen-2xl md:px-8 mx-auto">
        <header class=" flex justify-between items-center md:py-">
          {/* logo - start */}
          <a
            href="about-page"
            class="inline-flex items-center text-black-800 text-2xl md:text-3xl font-extrabold gap-2.5 mb-4"
            aria-label="logo"
          >
