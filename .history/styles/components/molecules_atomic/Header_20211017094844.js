      ...
      <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <header class=" flex justify-between items-center md:py-3">
          ...
          <nav class="hidden lg:flex gap-12">
            <a
              href="#"
              class="text-gray-600 hover:text-indigo-600 active:text-indigo-700 text-lg font-semibold transition duration-100"
            >
              Home
            </a>
            <a
              ...
              class="inline-flex items-center text-gray-600 hover:text-indigo-600 active:text-indigo-700 text-lg font-semibold transition duration-100 gap-1"
            >
              Features
              <svg
                xmlns="http://www.w3.org/2000/svg"
