...
export default function Header() {
  return (
    <div class="bg-gray-300 sticky top-0 z-50">
      <div class="max-w-screen-xl md:pr-8 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          {/* logo - start */}
          <a
            href="about-page"
            class="hover:text-indigo-700 hover:underline inline-flex items-center text-gray-800 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3"
            aria-label="logo"
          >
          ...
          <nav class="hidden lg:flex gap-9 mt-1 ml-8 underline">
            <a
              href="main-page"
              class="text-gray-500 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100"
            >
              Main
            </a>
            <a
              ...
              class="inline-flex items-center text-gray-500 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100 gap-1"
            >
              Record
