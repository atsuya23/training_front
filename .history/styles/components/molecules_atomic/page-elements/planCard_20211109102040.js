  ...
  return (
    <div class="flex flex-col bg-white border rounded-lg overflow-hidden">
      ...
      <div class="flex flex-col flex-1 p-4 sm:p-6">
        ...
        <p class="text-center text-bold text-red-400 font-bold mb-2">{set}</p>
        <p class="text-gray-600 font-semibold mb-1">Main : {main}</p>
        <p class="text-gray-600 mb-2">Sub : {sub}</p>
        <p class="text-gray-500 mb-3">{explain}</p>
        <p class="text-yellow-400 mb-8">⚠{danger}</p>
