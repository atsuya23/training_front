  ...
  return (
    <>
      ...
      <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-4 border-b border-dotted border-gray-400">
        ...
        <div>
          <div class="text-gray-500 text-semibold inline-block md:text-xl text-center sm:text-left py-3">
            <table class="table-fixed"><tr><th class="w-56">種目名</th><th>重量： セット、レップ内容</th></tr></table>
            <table class="table-fixed">
              <tr>
                <th class="w-56">{content.training_type}</th>
                <th>
