      ...
      <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div class="md:pt-8">
            ...
            <table class="table-fixed text-left font-normal italic text-gray-500 pb-1">
              <tr>
                <th class="w-44 pl-3">種目名</th>
                <th class="w-48"> 重量： セット、レップ内容</th>
                <th class="pl-3">総負荷</th>
              </tr>
            </table>
          ...
          <div>
            <div class="h-64 md:h-auto bg-gray-100 overflow-hidden rounded-lg lg:pt-16">
              <img
                src="https://training-rest.herokuapp.com/media/images/dumbbell.jpg"
                loading="lazy"
                alt="Photo by Martin Sanchez"
                class="w-full h-full object-cover object-center rounded-full shadow-lg py-4"
              />
            </div>
          </div>
        </div>
