      ...
      <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div class="md:pt-8">
            ...
            <h1 class="text-gray-800 text-2xl sm:text-3xl pt-2 font-bold text-center md:text-left mb-4 md:mb-6 inline-block">
              {training.created_at}
              <div class="underline text-xl inline-block">{training.place}</div>
            </h1>
