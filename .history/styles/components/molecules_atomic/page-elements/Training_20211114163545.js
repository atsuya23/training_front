...
export default function Training({ training }) {
  return (
    <>
      {/* Training - start */}
      <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-4 border-b border-indigo-300 hover:bg-white rounded-t-3xl rounded-b-sm duration-300 py-2 px-2">
