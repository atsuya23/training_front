export default function TRecordElement({ top, title, text, img }) {
  return (
    <>
      <div class="flex flex-col md:flex-row items-center gap-4 lg:gap-6 hover:bg-white rounded-3xl">
        ...
        <div class="flex flex-col gap-2">
          <span class="text-gray-400 text-sm">Summary</span>
          ...
          <div>
            <a
              href="#"
              class="text-indigo-500 hover:text-indigo-700 active:text-indigo-700 font-semibold transition duration-100"
            >
              Read more
            </a>
          </div>
