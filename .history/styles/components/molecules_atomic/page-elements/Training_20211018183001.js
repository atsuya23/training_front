export default function Training({ training }) {
  return (
    <>
      {/* person - start */}
      <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-4 border-b border-indigo-300">
        <div class="w-20 md:w-24 h-20 md:h-24 bg-gray-100 rounded-full overflow-hidden shadow-3xl">
          <img
        ...
        <div>
          ...
          <p class="text-gray-500 text-sm md:text-base text-center sm:text-left">
            {training.review && <p>revie : {training.review}</p>}
          </p>
