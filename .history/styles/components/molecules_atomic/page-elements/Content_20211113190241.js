  ...
  return (
    <>
      ...
      <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-4 border-b border-dotted border-gray-400">
        ...
        <div>
          <div class="text-gray-500 text-semibold inline-block md:text-xl text-center sm:text-left">
            {content.training_type} :
            <a class="text-red-400 text-sm md:text-xl text-center sm:text-left">
              {" "}
              {content.weight && `${contentweight}Kg * `} ( {content.set1}{" "}
