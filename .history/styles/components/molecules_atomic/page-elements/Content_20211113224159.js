export default function Content({ content }) {
  if (content.set3) {
    const reps = content.set1 + content.set2 + content.set3;
  } else if (content.set2) {
    const reps = content.set1 + content.set2;
  } else {
    const reps = content.set1;
  }
