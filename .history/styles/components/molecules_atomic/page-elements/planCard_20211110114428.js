export default function PlanCard({
  ...
  return (
    <div class="flex flex-col bg-white border rounded-3xl overflow-hidden shadow-lg">
      <a
        href="#"
        class="group h-48 md:h-64 block bg-gray-100 overflow-hidden relative  group-hover:scale-110"
      >
        <img
          src={picPath}
          loading="lazy"
          alt="Photo by Minh Pham"
          class="w-full h-full object-cover object-center absolute inset-0 transform transition duration-200"
        />
