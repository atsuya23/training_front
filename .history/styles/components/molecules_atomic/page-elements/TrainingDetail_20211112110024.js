...
import { getContentDateByTrainingId } from "../../atoms_atomic/func/contentFunc";
import { RESTAPI_URL } from "../../../../Secret";
import { render } from "react-dom";

const cookie = new Cookie();

export default function TrainingDetail({ training, trainingDeleted, contentIds }) {
  ...
  const contentDates = await getContentDateByTrainingId(training.id);
