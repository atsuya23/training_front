...
export default function ContentEachTotal({ content, id_training, training }) {
  const contentWithCreated_at = { ...content, content_created_at: "a" };
  console.log(contentWithCreated_at);
  return (
