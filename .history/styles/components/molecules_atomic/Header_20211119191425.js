...
export default function Header() {
  return (
    <>
      <div class="bg-black sticky top-0 z-50 shadow-xl rounded-2xl opacity-75">
        <div class="max-w-screen-xl md:pr-4 mx-auto pt-1">
          <header class=" flex justify-between items-center py-1 md:pt-1 md:pb-1">
            {/* logo - start */}
            <Link href="../main-page">
              <div
                class="hover:text-gray-50 inline-flex items-center text-gray-300 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 hover:bg-gray-600 pb-1 px-4 rounded-3xl ml-2 hover:opacity-100 cursor-pointer"
                aria-label="logo"
              >
                <img
                  src="https://training-rest.herokuapp.com/media/images/dumbbell_icon.jpg"
                  class="w-10 h-10 py-1 rounded-full animate-pulse"
                />
                Record Training
              </div>
            </Link>
            ...
            <button
              type="button"
              class="inline-flex items-center lg:hidden bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2 mb-1 mr-2"
            >
              <svg
