      ...
      <div class="max-w-screen-xl md:pr-4 mx-auto pt-1">
        <header class=" flex justify-between items-center py-1 md:pt-1 md:pb-1">
          ...
          <nav class="hidden lg:flex gap-7 mt-1 ml-8 ">
            <Link href="../main-page">
              <a class="text-gray-300 hover:text-white hover:bg-gray-700 rounded-lg active:text-gray-300 text-lg font-semibold transition duration-100 px-1 hover:underline hover:opacity-0">
                Main
              </a>
            </Link>
