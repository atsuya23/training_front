...
export default function Header() {
  return (
    <div class="bg-black sticky top-0 z-50 shadow-md">
      <div class="max-w-screen-xl md:pr-4">
        <header class=" flex justify-between items-center py-1 md:pt-2 md:pb-1">
          {/* logo - start */}
          <Link href="../main-page">
            <div
              class="hover:text-gray-50 hover:underline inline-flex items-center text-gray-300 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 animate-pulse hover:bg-gray-700 pb-2 px-4 rounded-3xl ml-2"
              aria-label="logo"
            >
          ...
          {/* buttons - start */}
          <div class="hidden text-right lg:flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5 -ml-8">
            <ModifyButton />
            <RegisterButton />
          </div>
