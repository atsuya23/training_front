...
export default function Header() {
  return (
    <div class="bg-black sticky top-0 z-50 shadow-xl rounded-full opacity-75">
      <div class="max-w-screen-xl md:pr-4 mx-auto pt-1">
        <header class=" flex justify-between items-center py-1 md:pt-1 md:pb-1">
          {/* logo - start */}
          <Link href="../main-page">
            <div
              class="hover:text-gray-50 inline-flex items-center text-gray-300 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 animate-pulse hover:bg-gray-600 pb-1 px-4 rounded-3xl ml-2 hover:opacity-100 hover:cursor-pointer"
              aria-label="logo"
            >
          ...
          {/* buttons - start */}
          <div class="hidden lg:flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5 -ml-8 hover:opacity-100">
            <ModifyButton />
            <RegisterButton />
          </div>
