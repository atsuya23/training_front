    ...
    <div class="bg-black sticky top-0 z-50 shadow-md">
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <Link href="../main-page">
            <a
              class="hover:text-gray-50 hover:underline inline-flex items-center text-gray-300 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3"
              aria-label="logo"
            >
              <PencilIcon class="w-8 h-9 text-gray-200 animate-pulse" />
              Record Training
            </a>
          </Link>
          {/* logo - end */}
          ...
          <nav class="hidden lg:flex gap-7 mt-1 ml-8 ">
            <Link href="../main-page">
              <a class="text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg active:text-gray-300 text-lg font-semibold transition duration-100 px-1 hover:underline">
                Main
              </a>
            </Link>
