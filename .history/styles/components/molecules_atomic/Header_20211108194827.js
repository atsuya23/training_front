    ...
    <div class="bg-black sticky top-0 z-50 shadow-md">
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center py-1 md:pt-2 md:pb-1">
          ...
          <Link href="../main-page">
            <div
              class="hover:text-gray-50 hover:underline inline-flex items-center text-gray-300 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 animate-pulse hover:bg-gray-700 pb-2 px-2 rounded-3xl"
              aria-label="logo"
            >
