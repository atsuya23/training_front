      ...
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <Link href="../about-page">
            <a
              class="hover:text-indigo-700 hover:underline inline-flex items-center text-gray-600 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 transition font-thin"
              aria-label="logo"
            >
