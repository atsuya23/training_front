      ...
      <div class="bg-gray-800 sticky top-0 z-50 shadow-xl rounded-2xl opacity-80">
        <div class="max-w-screen-xl md:pr-4 mx-auto pt-1">
          <header class=" flex justify-between items-center py-1 md:py-1">
            ...
            <button
              type="button"
              class="inline-flex items-center lg:hidden bg-white hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2 mb-1 mr-2"
