      ...
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <Link href="../about-page">
            <a
              class="hover:text-indigo-700 hover:underline inline-flex items-center text-gray-600 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3 transition"
              aria-label="logo"
            >
          ...
          <nav class="hidden lg:flex gap-7 mt-1 ml-8 underline">
            <Link href="../main-page">
              <a class="text-gray-500 hover:text-indigo-500 hover:bg-gray-200 rounded-lg active:text-indigo-700 text-lg font-semibold transition duration-100 px-1 transition">
                Main
              </a>
            </Link>
