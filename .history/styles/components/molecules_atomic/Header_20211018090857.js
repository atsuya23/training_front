    ...
    <div class="bg-gray-300 sticky top-0 z-50">
      <div class="max-w-screen-xl md:pr-4 mx-auto">
        <header class=" flex justify-between items-center md:py-1">
          ...
          <a
            href="about-page"
            class="hover:text-indigo-700 hover:underline  hover:animate-bounce inline-flex items-center text-gray-600 text-2xl md:text-3xl font-extrabold gap-2.5 mb-3"
            aria-label="logo"
          >
